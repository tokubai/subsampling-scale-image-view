...
import static jp.co.tokubai.subscaleview.test.R.layout.view_pager;
import static jp.co.tokubai.subscaleview.test.R.string.pager_p1_subtitle;
import static jp.co.tokubai.subscaleview.test.R.string.pager_p1_text;
import static jp.co.tokubai.subscaleview.test.R.string.pager_p2_subtitle;
import static jp.co.tokubai.subscaleview.test.R.string.pager_p2_text;
import static jp.co.tokubai.subscaleview.test.R.string.pager_title;
